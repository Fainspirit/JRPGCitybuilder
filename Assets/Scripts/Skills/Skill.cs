...
public class Skill : ScriptableObject
{
    ...
    public float ManaPowerMultiplier { get => GetManaPowerMultiplier(); }
    public float LevelPower { get => GetPowerFromLevel(); }
    ...
    public IEnumerator Cast(Battle battle, Unit target)
    {
        float power = GetManaPowerMultiplier() * GetPowerFromLevel();
